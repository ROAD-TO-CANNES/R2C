  ...
  <body>
    <div class="top">
      ...
      <form action="" method="GET" >
        <input type="date" name="date" id="filtreInput" value="<?= isset($_GET['date'])==true ? $_GET['date']:'' // Display the $_GET['date'] in the input?>" placeholder="Filtrer par utilisateur">
        <select name="user">
        ...
        <select name="action">
          ...
          <option value="Information"  <?= isset($_GET['action'])==true ? ($_GET['action']=='Information' ? 'selected':'' ):''// Display selected option if $_GET['action'] is set?> >Information</option>

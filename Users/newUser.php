...
<body>
  ...
  <form id="newUser-form" class="newUser-form" action="../Forms/newUserScript.php" method="post">
    ...
    <input type="password" id="newuserpsw" name="newuserpsw" placeholder="Mot de passe" required />
    <input type="password" id="newuserpsw2" name="newuserpsw2" placeholder="Confirmer le mot de passe" required />

...
<form id="change-password-form-user" class="change-password-form" action="../Forms/change_pswScript.php" method="post">
  ...
  <input type="password" name="new_psw" placeholder="Nouveau mot de passe" required />
  <input type="password" name="new_psw2" placeholder="Confirmer le nouveau mot de passe" required />

...
<body>
  ...
  <form id="newBP-form" class="newBP-form" action="../NewBP/newBPScript.php" method="post">
    <input type="text" id="nombp" name="nombp" placeholder="Nom de la bonne pratique" required />
    <?php
    ...
    <textarea id="descbp" name="descbp" placeholder="Décrivez la bonne pratique" rows="4" cols="50" required></textarea>
